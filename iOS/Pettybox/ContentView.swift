...
struct ContentView: View {
    @EnvironmentObject var store: PettyboxStore
    @EnvironmentObject var purchases: PurchaseManager

    @State private var showingAdd = false
    @State private var showingSettings = false
    @State private var showingPaywall = false
    @State private var editingEntry: PettyboxEntry?
    ...
    private func entryRow(_ entry: PettyboxEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: PettyboxEntry? = nil, onSave: @escaping (String, Double) -> Void) {
